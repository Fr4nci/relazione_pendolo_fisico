...
Per minimizzare le incertezze sul periodo di oscillazione (che \textbf{non} coincidono con la risoluzione del cronometro o al tempo di reazione di un individuo medio), abbiamo considerato i vari valori di $\tau$ misurati ad una certa distanza dal centro di massa e ne abbiamo calcolato il valor medio e la deviazione standard, che abbiamo poi diviso per il numero di oscillazioni fissato che abbiamo misurato. \\
Successivamente, i valori medi che noi abbiamo misurato ad una certa distanza sono stati utilizzati per costruire il grafico del fit lineare con Python, così come i valori di deviazione standard che sono stati inseriti all'interno di un altro array per essere usati come gli errori sulle ordinate di ogni singolo valore medio. \\
\begin{figure}[hptb]
